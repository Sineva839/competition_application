...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Курсы
        items.add(ItemCls(1,1,"Junior course","Начало курса",testText2,0,0,"simple_pit",check))
        items.add(ItemCls(1,2,"Junior course","Изучение основ",testText2,0,0,"simple_pit",check))
        items.add(ItemCls(1,3,"Junior course","Практика на деле",testText2,0,0,"simple_pit",check))
